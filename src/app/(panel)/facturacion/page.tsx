...
/* ============================================================
   ...
   Columnas: ID Factura · Cliente · Servicio · Fecha · Total
  ...
  return (
    <>
      ...
      <Panel>
        ...
        {/* Filtros en una sola fila para no gastar alto: búsqueda libre
            (ID, cliente o servicio), ámbito empresa/sede según el rol y
            fecha. La caja de búsqueda va en modo compacto y absorbe el
            espacio sobrante de la fila. */}
        <Toolbar>
          <FilterGroup>
            <SearchBox
              compact
              value={fQuery}
              onChange={setFQuery}
              placeholder={t("facturacion.filterQuery")}
            />
            {hayFiltroEmpresa && (
              <FilterSelect
                value={fEmpresaId}

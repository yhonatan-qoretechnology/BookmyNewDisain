...
const en: Dictionary = {
  ...
  reservas: {
    ...
    duracionTotal: "Total duration (min)",
    motivoOpcional: "Reason (optional)",
    motivoPlaceholder: "e.g. fibre reinforcement",
    extenderAyuda: "It currently lasts {actual} min. Enter the NEW TOTAL duration, not the minutes you are adding. If it overlaps the professional's next booking, the server rejects it.",
    extenderMayor: "The new duration must be longer than the current one ({actual} min)",
    extendida: "Booking extended to {minutos} min",
    extenderError: "The booking could not be extended",
    detalles: "Details",

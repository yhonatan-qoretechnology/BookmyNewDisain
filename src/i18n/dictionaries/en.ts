...
const en: Dictionary = {
  ...
  fijarPassword: {
    titulo: "Choose your password",
    sub: "You are activating access for {email}. Nobody else will know this password.",
    tituloInvalido: "Invalid link",
    tituloHecho: "All set",
    comprobando: "Checking the link…",
    sinToken: "The link is incomplete. Open it exactly as it arrived in the email.",
    enlaceInvalido: "The link is not valid or has expired.",
    pideOtro: "Ask your administrator to send you a new one.",
    nueva: "New password",
    reglas: "At least 7 characters, with a lowercase letter, an uppercase letter, a number and a symbol.",
    guardar: "Save password",
    hecho: "Password set. You can now sign in.",
    error: "The password could not be saved.",
  ...
  plan: {
    ...
    lockTitle: "Unlock {modulo} with Bookmy CRM Pro",
    lockLead: "Your free plan covers the day-to-day schedule. This module is part of Pro, along with everything that makes the business run itself.",
    tryTitle: "Try it free for 30 days",
    tryLead: "It starts right away, no card and no strings. When it ends your account goes back to the free plan and you lose no data.",
    tryCta: "Start my 30 free days",
    trying: "Activating…",
    tryDone: "Done! You have Bookmy CRM Pro for 30 days.",
    salesCta: "Talk to sales",
    backCta: "Back to the panel",
    modules: {
      facturacion: "billing",
      estadisticas: "statistics",
      stock: "stock and supplies",
      comunicacion: "messaging",
    },
    f1: "Billing and payments with full history",
    f2: "Live statistics of your business",
    f3: "Stock and supplies per branch",
    ...
    trialOverTitle: "Your Bookmy CRM Pro trial has ended",
    trialOverText: "You still have the whole free plan and all your data. To get billing, statistics, stock and messaging back, talk to us.",
    offerTitle: "Try Bookmy CRM Pro free for 30 days",
    offerText: "Billing, statistics, stock and messaging. No card needed.",
    offerCta: "Try it free",
    current: "Current plan",
    free: "Bookmy Free",
    pro: "Bookmy CRM Pro",
    trialUntil: "On trial until {fecha}",
  ...
  recuperar: {
    ...
    errCorta: "The password must be at least 7 characters and include a lowercase letter, an uppercase letter, a number and a symbol.",
  ...
  pages: {
    ...
    administradores: { title: "Admins", accent: "" },
  ...
  reservas: {
    editar: "Edit",
    editarTitulo: "Edit booking {id}",
    extenderHorario: "Extend time",
    extenderAyuda: "It currently lasts {actual} min. If it runs over and clashes with the professional's next booking, you can reassign, move or cancel that booking.",
    detalles: "Details",
    observacionEspera: "Waiting note",
    observacionPlaceholder: "e.g. arrived 10 min early; waiting for the previous client",
    observacionGuardada: "Note saved",
    observacionError: "The note could not be saved",
    notasCliente: "Client notes (not edited here):",
    precioAyuda: "Need to adjust the amount? Do it in Billing, adding extra items to the invoice.",
  ...
  clientes: {
    ...
    passwordShort: "The password must be at least 7 characters and include a lowercase letter, an uppercase letter, a number and a symbol.",
  ...
  facturacion: {
    ...
    adicionalQuitar: "Remove",
    adicionalQuitarSi: "Yes, remove",
    adicionalQuitado: "Extra removed and total updated",
    adicionalQuitarError: "The extra could not be removed",
    panelTitle: "Billing",
  ...
  estadisticas: {
    ...
    todo: "All",
    imprimir: "Print",
    informe: "Statistics report",
    periodo: "Period: {periodo}",
    periodoTodo: "all time",
    reservas: "Bookings",
    ingresos: "Revenue",
    ciudad: "City",
    usuarios: "Users",
    empresasTitle: "Companies with most bookings",
    empresasSub: "Excludes cancelled and no-shows",
    empleadosTitle: "Employees",
    empleadosSub: "Bookings and revenue per professional",
    ciudadesTitle: "Cities with most users",
    ciudadesSub: "From the mobile app location",
    serviciosTitle: "Services with most bookings",
    serviciosSub: "Computed on the server",
    ...
    masVistosTitle: "Most viewed",
    masVistosSub: "Views recorded from the mobile app",
    vistas: "Views",
    sinVistas: "No views recorded yet: the mobile app sends them when companies and professionals are opened",
    sinDatos: "No data for this period yet",
    hoy: "Today",
    exportar: "Export",
    datosEjemplo: "Sample data",
    ultimos12: "Last 12 months",
    kpiReservas: "Total bookings",
    kpiIngresos: "Revenue",
    kpiClientes: "New clients",
    kpiTicket: "Average ticket",
    kpiCancelacion: "Cancellation rate",
    kpiValoracion: "Average rating",
    reservasIngresos: "Bookings and revenue",
    periodoActual: "Current period",
    periodoAnterior: "Previous period",
    estadoReservas: "Booking status",
    totalReservas: "Total bookings",
    totalClientes: "Customers who booked",
    errorCarga: "Statistics could not be loaded. Check your connection and try again.",
    errorRecarga: "Statistics could not be refreshed: showing the last loaded data.",
    reintentar: "Retry",
    sinPeriodo: "No bookings in this period.",
    actualizando: "Updating…",
    indicadores: "Key metrics",
    indicador: "Metric",
    valor: "Value",
    variacion: "Change",
    ingresosMes: "Revenue per month",
    reservasDia: "Bookings by weekday",
    horasDemanda: "Peak hours",
    mayorDemanda: "Highest demand",
    menorDemanda: "Lowest demand",
    topEmpresas: "Companies with most bookings",
    topServicios: "Best-selling services",
    topProfesionales: "Top-billing professionals",
    topPorReservas: "Top 5 by number of bookings",
    topPorIngresos: "Top 5 by revenue generated",
    colProfesional: "Professional",
    colEmpresa: "Company",
    colImporte: "Amount",
    rendimiento: "Bookmy performance",
    rendimientoSub: "Conversion rate of the booking flow",
    crecimiento: "Client growth",
    crecimientoSub: "New vs returning",
    nuevos: "New",
    recurrentes: "Returning",
    distribucion: "Distribution by branch/city",
    distribucionSub: "Total bookings",
    ultimasReservas: "Latest bookings",
    ultimasSub: "Most recent bookings",
    dias: { lun: "Mon", mar: "Tue", mie: "Wed", jue: "Thu", vie: "Fri", sab: "Sat", dom: "Sun" },
    plural: {
      confirmada: "Confirmed",
      atendida: "Completed",
      cancelado: "Cancelled",
  ...
  configuracion: {
    ...
    passTooShort: "The password must be at least 7 characters and include a lowercase letter, an uppercase letter, a number and a symbol.",
  ...
  /* Extending an in-progress appointment and resolving conflicts */
  extender: {
    enCurso: "In progress",
    horario: "{inicio} – {fin}",
    ...
    motivoPlaceholder: "e.g. the client asked for a touch-up",
    ...
    sinEspecialistas: "No other specialist offering this service is free at that time.",
    elegirEspecialista: "Choose who takes it:",
    huecos: "Free slots today with the same length:",
    sinHuecos: "No free slots left today with the same length.",
    otroHorario: "Pick another day or time",
    cancelarTitle: "Cancel the appointment",
    cancelarMsg: "Cancel {cliente}'s appointment at {hora}? They will be notified.",
    cancelarNota: "The appointment is cancelled, the slot is freed and the client is notified.",
    cancelarConfirm: "Yes, cancel appointment",
    reasignada: "Appointment reassigned to {nombre}",
    reprogramada: "Appointment moved to {hora}",
    cancelada: "Appointment cancelled",
    reintentando: "Applying the extension…",
    cerrar: "Close",
  },

...
const es = {
  ...
  reservas: {
    ...
    duracionTotal: "Duración total (min)",
    motivoOpcional: "Motivo (opcional)",
    motivoPlaceholder: "Ej. refuerzo de fibra",
    extenderAyuda: "Ahora dura {actual} min. Escribe la duración TOTAL nueva, no los minutos que añades. Si se solapa con la siguiente cita del profesional, el servidor la rechaza.",
    extenderMayor: "La nueva duración debe ser mayor que la actual ({actual} min)",
    extendida: "Reserva ampliada a {minutos} min",
    extenderError: "No se pudo ampliar la reserva",
    detalles: "Detalles",
